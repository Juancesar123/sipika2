...
class KphknontnController extends CI_Controller {
    ...
    public function index(){
        ...
        return $this->load->view('pages/kphknontn',$data);
    }
    public function get(){
        $client     = new GuzzleHttp\Client();
        $result = $client->get(constant('API_URL').'/kphk-nontn');
        /*
    ...
    public function store(){
        ...
        $result = $client->post(constant('API_URL').'/kphk-nontn',[
            'multipart'=>[
                [
                    'name' => 'dokumen_sk',
    ...
    public function destroy($id){
        $client     = new GuzzleHttp\Client();
        $result = $client->delete(constant('API_URL').'/kphk-nontn/'.$id);
        echo 'sukses';
    }
    public function show($id){
        $client     = new GuzzleHttp\Client();
        $result = $client->get(constant('API_URL').'/kphk-nontn/'.$id);
        /*
            Hasil  data dari api tadi di getBody()->getContents(); agar semua isi data di api
            ke ambil. lalu jangan lupa di parse ke json karna datanya berupa stream string
        */
    ...
    public function update(){
        ...
        if($status == 'filenotfound'){
            ...
            var_dump($id);
            $result = $client->put(constant('API_URL').'/kphk-nontn/'.$id,[
                'multipart'=>[
                    [
                        'name' => 'dokumen_sk',
