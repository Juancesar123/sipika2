...
class OpenAreaKawasanController extends CI_Controller {
    ...
    public function getData($id){
        ...
        $result = $client->get(constant('API_URL').'/open-area-perkawasan?nama_kawasan='.$id);
        /*
    ...
    public function store(){
        ...
        $result = $client->post(constant('API_URL').'/open-area-perkawasan',[
            'multipart'=>[
                [
                    'name' => 'file_shp',
                ...
                [
                    'name' => 'file_shp',
                    'contents' => 'openareakawasan/'.$nameshp
                ],
                [
                    'name' => 'file_jpeg',
                ...
                [
                    'name' => 'file_jpeg',
                    'contents' => 'openareakawasan/'.$namejpeg
                ],
                [
                    'name' => 'file_table',
                ...
                [
                    'name' => 'file_table',
                    'contents' => 'openareakawasan/'.$nametable
                ],
                [
                    'name' => 'nama_kawasan',
    ...
    public function destroy($id){
        $client     = new GuzzleHttp\Client();
        $result = $client->delete(constant('API_URL').'/open-area-perkawasan/'.$id);
    }
    public function show($id){
        $client     = new GuzzleHttp\Client();
        $result = $client->get(constant('API_URL').'/open-area-perkawasan/'.$id);
        /*
            Hasil  data dari api tadi di getBody()->getContents(); agar semua isi data di api
            ke ambil. lalu jangan lupa di parse ke json karna datanya berupa stream string
        */
    ...
    public function update(){
        ...
        if($status == 'filenotfound'){
            $id = $this->input->post('idopenkawasan');
            $result = $client->put(constant('API_URL').'/open-area-perkawasan/'.$id,[
                'multipart'=>[
