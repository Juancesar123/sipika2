                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills">
                                      <li class="nav-item">
                                        <a class="nav-link active" data-toggle="pill" href="#home">Satwa & Tumbuhan</a>
                                      </li>
                                      <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#menu1">Desa</a>
                                      </li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                      ...
                                      <div class="tab-pane container fade" id="menu1">
                                          <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Masukkan Desa</label>
                                                    <input type="text"  class="form-control" id="namadesa" name="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Masukkan Luas Dari(Ha)</label>
                                                    <input type="text"  class="form-control" id="luas" name="">
                                                    <label>Masukkan Luas Sampai(Ha)</label>
                                                    <input type="text"  class="form-control" id="luas" name="">
                                                </div>
                                                <button class="btn btn-primary" id="cari2"><i class="fa fa-search" ></i> Cari</button>
                                            </div>
        ...
        $('document').ready(function(){
            $('#cari2').click(function(){
                ...
                var filter = $("#filterby").val(); 
                    $.ajax({
                        url:'pencarian/cari/'+filter,
                        method:'GET',
                        success:function(data){
                            var result  = JSON.parse(data);
                            console.log(result);
                           result.forEach(function(element) {
                                var n = element.nama.search(katakunci);
