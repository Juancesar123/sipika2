...
//endroute profile
$route['downloadtemplatepengelolaankawasan'] = "DownloadtemplateController/pengelolaankawasan";
$route['downloadtemplateprovinsi'] = "DownloadtemplateController/provinsi";
$route['downloadtemplatepotensipiaps'] = "DownloadtemplateController/potensipiaps";
$route['downloadsketsasejarah'] = "DownloadtemplateController/sketsasejarah";
$route['downloadtemplatekphktn'] ="DownloadtemplateController/kphktn";
$route['downloadtemplatekphknontn'] ="DownloadtemplateController/kphknontn";
$route['downloadtemplateusulantahura'] ="DownloadtemplateController/usulantahura";
$route['downloadtemplatekawasankonservarsi'] ="DownloadtemplateController/kawasankonsevarsi";
$route['downloadtemplatepengukuhankawasan'] ="DownloadtemplateController/pengukuhankawasan";
$route['downloadtemplateekflapangan'] ="DownloadtemplateController/ekflapangan";
$route['downloadtemplateevaluasideskstudy'] ="DownloadtemplateController/evaluasideskstudy";
$route['downloadtemplateindikasitora'] ="DownloadtemplateController/indikasitora";
$route['downloadtemplatehutanadatdalamkk'] ="DownloadtemplateController/hutanadatdalamkk";
$route['downloadtemplatedesasekitarkk'] ="DownloadtemplateController/desasekitarkk";
$route['downloadtemplatewilayahadat'] ="DownloadtemplateController/wilayahadat";
$route['downloadtemplatepermasalaanpengelolaankk'] ="DownloadtemplateController/permasalahanpengelolaankk";
$route['downloadpotensikawasankonservarsi'] ="DownloadtemplateController/potensikawasankonservarsi";
$route['downloadtemplatekeanekaragamanhayati'] ="DownloadtemplateController/keanekaragamanhayati";
$route['downloadtemplatesosekbud'] ="DownloadtemplateController/sosekbud";
$route['downloadtemplatepenutupanlahan'] ="DownloadtemplateController/penutupanlahanperkawasan";
$route['downloadtemplateopenareaperkawasan'] ="DownloadtemplateController/openareaperkawasan";
$route['downloadpetakawasankonsevarsi'] ="DownloadtemplateController/petakawasankonsevarsi";
$route['downloadtemplatefotokawasankonservarsi'] ="DownloadtemplateController/fotokawasankonservarsi";
$route['downloadtemplatepenguatanfungsikk'] ="DownloadtemplateController/penguatanfungsikk";
$route['downloadtemplatepembangunanstrategis'] ="DownloadtemplateController/pembangunanstrategis";
$route['downloadtemplatekemitraankonservarsi'] ="DownloadtemplateController/kemitraankonservarsi";
$route['downloadtemplateperkembanganzonasitn'] ="DownloadtemplateController/perkembanganzonasitn";
$route['downloadtemplateperkembanganbloktn'] ="DownloadtemplateController/perkembanganbloktn";
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
